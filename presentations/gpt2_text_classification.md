...
# <!-- fit --> Text Classification using GPT2
...
![bg horizontal right fit:100% 60%](decoder_transformers.png)
![bg fit](gpt2_decoder.png)
...
* Our new text ***"a robot must obey"*** is fed to GPT2.
